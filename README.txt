...
Thnaks for visiting!
Please see examples of proof that I can build predictive models using a variety of methods to respond to business questions.

SQL DATA WRANGLING
	see query.sql for a sample of a complex CTE data lakehouse query
...
LinearRegression
	...
	e.g. fixing an old car; you can get in there, replace parts, test, and see how components interact
